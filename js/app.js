(() => {
  ...
  window.addEventListener("scroll", () => {
    ...
    e <= 0
      ? he.classList.remove(fe)
      : (e > ge && !he.classList.contains(me)
          ? (he.classList.remove(fe), he.classList.add(me))
          : e < ge &&
            he.classList.contains(me) &&
            (he.classList.remove(me), he.classList.add(fe)),
        (ge = e));
  });
})();
